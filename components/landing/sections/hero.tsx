...
// ABOUTME: Interactive demo showing AI visibility optimization (supports waitlist mode)

"use client";

import { useState, useEffect } from "react";
import { Button } from "@/components/ui/button";
import { Play, ArrowRight, Loader2, Infinity } from "lucide-react";
  ...
  return (
    <section className="relative">
      ...
      <div className="container mx-auto px-4 pt-12 pb-8 md:pt-16 md:pb-10 text-center">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold leading-snug tracking-tight text-foreground mb-6 max-w-3xl mx-auto">
          Dominate your niche in{" "}
          <span className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">AI search.</span>
        </h1>
        <p className="text-base md:text-lg text-muted-foreground mb-4 max-w-2xl mx-auto">
          Rank in ChatGPT, Perplexity, and Claude. Get found where your customers actually search.
        </p>
        <p className="text-sm text-muted-foreground/70 mb-8 max-w-xl mx-auto">
          AEO-optimized content in minutes. No technical skills needed.
        </p>
      ...
      <div className="container mx-auto px-4 pb-8">
        <div className="relative rounded-xl border border-border bg-card shadow-xl overflow-hidden mx-auto max-w-5xl">
          {/* Unlimited badge - reinforces value prop */}
          <div className="absolute top-3 right-3 z-10 flex items-center gap-2">
            ...
            <div className="flex items-center gap-1.5 bg-muted/50 border border-border/50 rounded-full px-3 py-1">
              <span className="text-xs text-muted-foreground line-through">5/50 credits</span>
            </div>
          </div>
          {/* App mockup */}
