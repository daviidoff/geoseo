...
const features = [
  ...
  },
  {
    emoji: "🌍",
    title: "45 Languages",
    description: "Generate keywords and content in 45 languages including English, Spanish, German, French, Japanese, Chinese, and more.",
  },
  {
    emoji: "📊",
    title: "AEO Health Check",
    description: "29-point website audit for AEO readiness. Get actionable insights to improve AI crawler visibility.",
  },
  {
    emoji: "🚀",
