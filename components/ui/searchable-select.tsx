      ...
      <PopoverTrigger asChild>
        <div className="relative w-full">
          <input
            ...
            disabled={disabled}
            className={cn(
              'flex h-10 w-full rounded-md border border-foreground/20 bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground/20 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
              className
            )}
            role="combobox"
            aria-expanded={open}
