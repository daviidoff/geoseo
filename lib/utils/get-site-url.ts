...
// ABOUTME: Handles localhost, Render deployments, and custom domains properly
 ...
 * 2. RENDER_EXTERNAL_URL (for Render deployments)
...
export function getSiteUrl(options: GetSiteUrlOptions = {}): string {
  ...
  if (
    allowOriginFallback &&
    requestOrigin &&
    isAllowedFallbackOrigin(requestOrigin, explicitOrigin, allowedHosts, renderHost)
  ) {
    return requestOrigin
  }
