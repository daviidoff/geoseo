 ...
 * @param model - Model name (e.g., 'models/gemini-3-flash-preview' or 'gemini-3-flash-preview')
 * @returns Normalized model name (e.g., 'gemini-3-flash-preview')
 */
 ...
 * @param model - Normalized model name (e.g., 'gemini-3-flash-preview')
