...
describe('useCSVParser', () => {
  ...
  describe('Successful Parsing', () => {
    it('should parse CSV file successfully', async () => {
      ...
      ;(csvParser.parseCSV as ReturnType<typeof vi.fn>).mockResolvedValue(mockParsedData)
  ...
  describe('Parse Errors', () => {
    it('should handle parse errors gracefully', async () => {
      ...
      ;(csvParser.parseCSV as ReturnType<typeof vi.fn>).mockRejectedValue(new Error(errorMessage))
    ...
    it('should track analytics on parse error', async () => {
      ;(csvParser.parseCSV as ReturnType<typeof vi.fn>).mockRejectedValue(new Error('Parse failed'))
    ...
    it('should handle non-Error exceptions', async () => {
      ;(csvParser.parseCSV as ReturnType<typeof vi.fn>).mockRejectedValue('String error')
  ...
  describe('State Management', () => {
    ...
    it('should clear error only', async () => {
      ;(csvParser.parseCSV as ReturnType<typeof vi.fn>).mockRejectedValue(new Error('Error'))
    ...
    it('should clear previous error on new parse attempt', async () => {
      ;(csvParser.parseCSV as ReturnType<typeof vi.fn>)
